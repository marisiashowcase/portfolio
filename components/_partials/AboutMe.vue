                    ...
                    <div class="padding-30 exp-history">
                        ...
                        <div class="exp">
                            ...
                            <div class="media-body">
                                ...
                                <!-- COmpany Logo -->
                                <div class="company-logo"> <img src="../../assets/images/company-logo-1.jpg" alt="" > </div>
                        ...
                        <div class="exp">
                            ...
                            <div class="media-body">
                                ...
                                <!-- COmpany Logo -->
                                <div class="company-logo"> <img src="../../assets/images/company-logo-2.jpg" alt="" > </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="blog">
                <div class="inside-sec">
                    ...
                    <section class="blog blog-page padding-20 padding-top-50 padding-bottom-50 ">
                        ...
                        <!-- Blog Post -->
                        <article> <img class="img-responsive" src="../../assets/images/blog-img-1.jpg" alt="" >
                            <div class="post-info">
                                <div class="post-in">
                        ...
                        <!-- BLOG POST -->
                        <article> <img class="img-responsive" src="../../assets/images/blog-img-2.jpg" alt="" >
                            <div class="post-info">
                                <div class="post-in">
                                    <div class="extra"> <span><i class="icon-calendar"></i>Aug 29, 2015</span> <span class="margin-left-15"><i class="icon-user"></i>Admin</span> <span class="margin-left-15"><i class="icon-bubbles"></i> Featured</span></div>
                                    <a href="#." class="tittle-post"> ENJOYING THE SMALL THINGS </a>
                        ...
                        <article> <img class="img-responsive" src="../../assets/images/blog-img-3.jpg" alt="" >
                            <div class="post-info">
                                <div class="post-in">
                                    <div class="extra"> <span><i class="icon-calendar"></i>Aug 29, 2015</span> <span class="margin-left-15"><i class="icon-user"></i>Admin</span> <span class="margin-left-15"><i class="icon-bubbles"></i> Featured</span></div>
                                    <a href="#." class="tittle-post"> ENJOYING THE SMALL THINGS </a>
